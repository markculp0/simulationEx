...
Lastly, the 95% confidence interval for the distribution of averages is calculated above, and the number of mean values that fall within that interval is also listed.
