...
```
This histogram shows how the density of the exponential distribution changes according to its rate parameter.  It is downward sloping, at a decreasing rate.  It appears nothing like a normal, bell-shaped distribution.
...
Now this distribution appears to be much more normal and bell-shaped.  This is the Central Limits Theorem at work. Lets compare the means and variances of the two distributions with the theoretical mean and variance of an exponential distribution.  
...
Our initial histogram of the exponential distribution of averages appeared normal.  We now conduct some tests to assess that fact.
